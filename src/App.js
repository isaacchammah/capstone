...
function App() {
  ...
  return (
    <>
      <Routes>
        <Route path='/indexes/' element={<Indexes mD={mD} sD={sD} setDM={setDM} setDS={setDS} mean={mean} setMean={setMean} mS={mS} sS={sS} setSS={setSS} setSM={setSM}  risk={risk} setRisk={setRisk}   indexName={indexName} setIndexName={setIndexName}  />} />
